...
results_density_continous <- results_density_continous %>% mutate(Analytical_model = "Multivariable Nutrient Density Model")
...
results_density_quartile <- results_density_quartile %>% mutate(Analytical_model = "Multivariable Nutrient Density Model")
...
results_density_quintile <- results_density_quintile %>% mutate(Analytical_model = "Multivariable Nutrient Density Model")
...
#     model<-coxph(formula=as.formula(paste(test_table$y,"~",mandatory,adj,"+AGE_CONTINIOUS+GENDER+SMOKING+TOTAL_ENERGY+MENOPAUSAL_STATUS+HORMONE_THERAPY_USE+PARITY+ORAL_CONTRACEPTIVE_USE+COHORT_YEAR")),data=data)
#   }
#   if(test_table$GENDER!="Female"){
#     model<-coxph(formula=as.formula(paste(test_table$y,"~",mandatory,adj,"+AGE_CONTINIOUS+GENDER+SMOKING+TOTAL_ENERGY+COHORT_YEAR")),data=data)
#   }
#   cat("Model HR and CI \n")
